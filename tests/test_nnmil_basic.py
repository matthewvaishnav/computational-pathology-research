...
class TestnnMILBasic:
    ...
    def test_single_scale_with_attention(self):
        ...
        assert attention.shape == (4, 100), f"Expected attention shape (4, 100), got {attention.shape}"
    ...
    def test_attention_masking(self):
        ...
        assert masked_attention < 0.01, f"Masked patches should have ~0 attention, got {masked_attention}"
