...
class TestAnnotationCRUD:
    ...
    def test_get_annotations_by_slide(self, client, sample_annotation_data):
        ...
        response = client.get(
            "/api/annotations", params={"slide_id": sample_annotation_data["slide_id"]}
        )
        assert response.status_code == 200
    ...
    def test_update_annotation(self, client, sample_annotation_data):
        ...
        # Update annotation
        update_data = {"label": "normal", "confidence": 0.98, "comments": "Updated comment"}
...
class TestAnnotationQueue:
    ...
    def test_assign_task(self, client, sample_queue_item):
        ...
        response = client.post(
            f"/api/queue/{sample_queue_item.task_id}/assign", params={"expert_id": "expert_001"}
        )
        assert response.status_code == 200
...
class TestDataModels:
    ...
    def test_annotation_create_validation(self):
        ...
        data = AnnotationCreate(
            ...
            geometry=AnnotationGeometry(
                type=AnnotationType.POLYGON, points=[Point(x=0, y=0), Point(x=100, y=100)]
            ),
            confidence=0.95,
            expert_id="expert_001",
        )
...
class TestAnnotationTimeTracking:
    ...
    def test_quality_trends_weekly_granularity(self, client, sample_annotation_data):
        ...
        # Get weekly trends
        response = client.get("/api/quality/quality-trends", params={"granularity": "weekly"})
        assert response.status_code == 200
...
class TestQualityControlEndpoints:
    ...
    def test_inter_rater_agreement_endpoint(self, client):
        ...
        annotation_data_1 = {
            ...
            "task_id": None,
            "label": "tumor",
            "geometry": {"type": "circle", "center": {"x": 50.0, "y": 50.0}, "radius": 20.0},
            "confidence": 0.9,
        ...
        annotation_data_2 = {
            ...
            "task_id": None,
            "label": "tumor",
            "geometry": {"type": "circle", "center": {"x": 55.0, "y": 55.0}, "radius": 20.0},
            "confidence": 0.85,
