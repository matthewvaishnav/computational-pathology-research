...
class WSISyntheticGenerator(DatasetGenerator):
    ...
    def _generate_slide(self, slide_id: str, spec: WSISyntheticSpec) -> Dict[str, Any]:
        ...
        patches = self._generate_patch_info(
            width, height, spec.patch_size, tissue_regions
        )
    ...
    def _generate_tissue_regions(
        ...
        for i in range(num_regions):
            ...
            region_width = self.rng.randint(
                int(region_size * 0.7), int(region_size * 1.3)
            )
    ...
    def validate_samples(self, samples: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for slide in slides:
                ...
                required_fields = [
                    "slide_id", "dimensions", "levels", "patch_size",
                    "tissue_percentage", "tissue_regions", "patches", "num_patches"
                ]
