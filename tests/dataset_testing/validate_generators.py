...
from dataset_testing.synthetic.camelyon_generator import CAMELYONSyntheticGenerator, CAMELYONSyntheticSpec
from dataset_testing.synthetic.multimodal_generator import MultimodalSyntheticGenerator, MultimodalSyntheticSpec
...
def validate_file_saving() -> bool:
    ...
    try:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            pcam_samples = pcam_generator.generate_samples(10, output_dir=temp_path / "pcam")
            ...
            camelyon_dataset = camelyon_generator.generate_samples(5, output_dir=temp_path / "camelyon")
            ...
            multimodal_dataset = multimodal_generator.generate_samples(5, output_dir=temp_path / "multimodal")
