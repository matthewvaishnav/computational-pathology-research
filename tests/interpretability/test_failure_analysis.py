...
class TestIdentifyFailures:
    ...
    def test_identify_failures_basic(self):
        ...
        assert list(result.columns) == ['slide_id', 'prediction', 'ground_truth', 'confidence', 'is_failure']
...
class TestClusterFailures:
    ...
    def test_cluster_failures_zero_failures(self):
        ...
        metadata = pd.DataFrame(columns=['slide_id', 'prediction', 'ground_truth', 'confidence', 'is_failure'])
...
class TestExportFailureReport:
    ...
    def test_export_failure_report_basic(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert len(df) == 3
            assert list(df.columns) == ['slide_id', 'prediction', 'ground_truth', 'confidence', 'cluster_assignment']
