...
class TestGenomicEncoder:
    ...
    def test_genomic_encoder_custom_hidden_dims(self):
        ...
        encoder = GenomicEncoder(input_dim=1000, hidden_dims=[512, 256, 128], output_dim=64)
    ...
    def test_genomic_encoder_without_batch_norm(self):
        ...
        encoder = GenomicEncoder(input_dim=2000, output_dim=256, use_batch_norm=False)
...
class TestClinicalTextEncoder:
    ...
    def test_clinical_text_encoder_pooling_strategies(self):
        ...
        # Test CLS pooling
        encoder_cls = ClinicalTextEncoder(vocab_size=5000, output_dim=128, pooling="cls")
        output_cls = encoder_cls(token_ids)
        assert output_cls.shape == (2, 128)

        # Test mean pooling
        encoder_mean = ClinicalTextEncoder(vocab_size=5000, output_dim=128, pooling="mean")
        output_mean = encoder_mean(token_ids)
        assert output_mean.shape == (2, 128)

        # Test max pooling
        encoder_max = ClinicalTextEncoder(vocab_size=5000, output_dim=128, pooling="max")
    ...
    def test_clinical_text_encoder_long_sequence(self):
        ...
        encoder = ClinicalTextEncoder(vocab_size=10000, output_dim=256, max_seq_length=128)
    ...
    def test_clinical_text_encoder_invalid_pooling(self):
        """Test that invalid pooling strategy raises error."""
        encoder = ClinicalTextEncoder(vocab_size=10000, output_dim=256, pooling="invalid")
