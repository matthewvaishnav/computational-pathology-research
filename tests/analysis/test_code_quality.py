...
class TestCodeQualityScanner:
    ...
    def test_analyze_complexity_success(self, mock_run):
        ...
        mock_radon_output = {
            "src/module1.py": [
                {"type": "function", "name": "simple_function", "lineno": 1, "complexity": 2},
                {"type": "function", "name": "complex_function", "lineno": 10, "complexity": 15},
            ],
            "src/module2.py": [
                {"type": "function", "name": "another_function", "lineno": 5, "complexity": 8}
            ],
        }
...
'''
        ...
        mock_radon_output = {
            "src/sample_module.py": [
                {"type": "function", "name": "simple_function", "lineno": 1, "complexity": 1},
                {"type": "function", "name": "moderate_complexity", "lineno": 5, "complexity": 4},
                {
                    "type": "function",
