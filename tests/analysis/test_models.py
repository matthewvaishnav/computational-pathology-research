...
class TestAnalysisDataclasses:
    ...
    def test_architecture_analysis_with_data(self):
        ...
        large_files = [
            {'path': 'src/large.py', 'lines': 1000, 'complexity': 25.5}
        ]
    ...
    def test_performance_analysis_with_data(self):
        ...
        bottlenecks = [
            {'operation': 'data_loading', 'time_ms': 150.5, 'percentage': 25.0}
        ]
...
class TestAnalysisResult:
    ...
    def test_analysis_result_get_json_schema(self):
        ...
        required_fields = [
            "timestamp", "project_path", "git_commit", "architecture",
            "performance", "coverage", "code_quality", "dependencies",
            "deployment", "security", "scalability", "overall_score"
        ]
