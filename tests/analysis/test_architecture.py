...
''')
        ...
        self.create_python_file('src/utils/helper.py', '''
import json
from src.models import base
''')
        
        self.create_python_file('src/models/base.py', '''
import numpy as np
''')
    ...
    def test_build_import_graph_syntax_error(self):
        ...
        self.create_python_file('src/broken.py', '''
import os
def broken_function(
...
'''
    ...
    def test_detect_circular_dependencies_external_imports(self):
        ...
        self.create_python_file('src/a.py', '''
import os
import numpy as np
from src.b import func_b
''')
        self.create_python_file('src/b.py', '''
import sys
import pandas as pd
...
'''
    ...
    def test_calculate_architecture_score(self):
        ...
        coupling_metrics = {'high_coupling_modules': [{'module': 'high1'}, {'module': 'high2'}]}  # 2 high coupling
    ...
    def test_calculate_architecture_score_clamping(self):
        ...
        large_files = [{'path': f'file{i}.py', 'lines': 600} for i in range(100)]  # Many large files
...
''')
        ...
        with patch.object(analyzer, '_get_file_complexity', return_value=5.0), \
