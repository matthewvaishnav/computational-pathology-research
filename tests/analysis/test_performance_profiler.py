...
class TestPerformanceProfiler:
    ...
    def test_calculate_performance_score_many_bottlenecks(self):
        ...
        gpu_util = 85.0
        bottlenecks = [{'operation': f'bottleneck_{i}', 'time_ms': 100} for i in range(5)]  # 5 bottlenecks
        memory_peak = 8.0
    ...
    def test_calculate_performance_score_bounds(self):
        ...
        # Test minimum bound
        gpu_util = 0.0
        bottlenecks = [{'operation': f'bottleneck_{i}', 'time_ms': 100} for i in range(10)]  # Many bottlenecks
    ...
    def test_analyze_integration(self, mock_score, mock_flame, mock_memory, mock_bottlenecks, mock_gpu):
