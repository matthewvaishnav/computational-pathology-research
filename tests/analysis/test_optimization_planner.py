...
class TestOptimizationPlanner:
    ...
    def _create_sample_analysis_result(self) -> AnalysisResult:
        ...
        return AnalysisResult(
            ...
            coverage=CoverageAnalysis(
                ...
                flaky_tests=[
                    "tests/test_integration.py::test_concurrent_access"
                ],
                score=68.0
            ),
            ...
            dependencies=DependencyAnalysis(
                ...
                vulnerabilities=[
                    {"package": "pillow", "severity": "high", "cve": "CVE-2023-1234"}
                ],
                unused_dependencies=[],
                license_issues=[],
                score=65.0
    ...
    def test_dependency_resolution_security_first(self):
        ...
        p0_security_tasks = [t.id for t in plan.tasks 
                            if t.role == Role.SECURITY and t.priority == Priority.P0]
    ...
    def test_role_assignment_performance_tasks(self):
        ...
        perf_tasks = [t for t in plan.tasks if 'gpu' in t.title.lower() or 'performance' in t.title.lower()]
    ...
    def test_role_assignment_security_tasks(self):
        ...
        # Find security tasks
        security_tasks = [t for t in plan.tasks if 'security' in t.title.lower() or 'vulnerabilities' in t.title.lower()]
    ...
    def test_role_assignment_testing_tasks(self):
        ...
        # Find testing tasks
        test_tasks = [t for t in plan.tasks if 'test' in t.title.lower() or 'coverage' in t.title.lower()]
