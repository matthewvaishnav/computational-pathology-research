...
def complete_result():
    ...
    return AnalysisResult(
        ...
        performance=PerformanceAnalysis(
            ...
            bottlenecks=[
                {"function": "data_preprocessing", "time_ms": 2500, "file": "src/data/preprocess.py"},
        ...
        security=SecurityAnalysis(
            vulnerabilities=[
                {"title": "SQL injection risk", "severity": "critical", "file": "src/db/queries.py"},
...
class TestReportIntegration:
    ...
    def test_markdown_table_formatting(self, generator, complete_result):
        ...
        dimensions = [
            "Architecture", "Performance", "Coverage", "Code Quality",
    ...
    def test_large_dataset_handling(self, generator):
        ...
        large_result = AnalysisResult(
            ...
            scalability=ScalabilityAnalysis(
                memory_bottlenecks=[f"bottleneck_{i}" for i in range(12)],
                score=68.0
            ),
            overall_score=64.5,
            critical_issues=[]
    ...
    def test_unicode_content_handling(self, generator):
        ...
        result = AnalysisResult(
            ...
            architecture=ArchitectureAnalysis(
                large_files=[
                    {"path": "src/файл.py", "lines": 600, "complexity": 10.0}  # Cyrillic
                ],
                score=70.0
            ),
            performance=PerformanceAnalysis(score=65.0),
