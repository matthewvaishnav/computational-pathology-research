...
class TestStudyDiscovery:
    ...
    def test_discover_wsi_studies_basic(self, pacs_connector, mock_pacs_service):
        ...
        # Mock query response
        mock_pacs_service.pacs_adapter.query_engine.query_studies.return_value = (
            mock_studies
        )
    ...
    def test_discover_wsi_studies_respects_max_results(
    ...
    def test_discover_wsi_studies_with_date_range(
        self, pacs_connector, mock_pacs_service
    ):
...
class TestIncrementalUpdates:
    ...
    def test_incremental_query_uses_last_timestamp(
        self, pacs_connector, mock_pacs_service
    ):
    ...
    def test_get_incremental_updates_convenience_method(
        self, pacs_connector, mock_pacs_service
    ):
...
class TestDataLoadingAndPreprocessing:
    ...
    def test_load_wsi_data_basic(
        self, pacs_connector, mock_pacs_service, temp_cache_dir
    ):
    ...
    def test_preprocessed_tensor_shape(
        self, pacs_connector, mock_pacs_service, temp_cache_dir
    ):
    ...
    def test_normalization_applied(
        ...
        tensor_normalized = pacs_connector.load_wsi_data(
            study_uid, normalize=True
        )
    ...
    def test_audit_logging_for_retrieval(
        self, pacs_connector, mock_pacs_service, temp_cache_dir
    ):
