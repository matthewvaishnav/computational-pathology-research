...
from experiments.benchmark_system.result_validator import (
    ResultValidator,
    ValidationIssue
)
...
class TestErrorClassification:
    ...
    def test_classify_installation_error(self):
        ...
        for error in errors:
            ...
            assert category == ErrorCategory.INSTALLATION, (
    ...
    def test_classify_timeout_error(self):
        ...
        for error in errors:
            ...
            assert category == ErrorCategory.TIMEOUT, (
                f"Should classify as TIMEOUT: {error}"
            )
    ...
    def test_classify_resource_error(self):
        ...
        for error in errors:
            ...
            assert category == ErrorCategory.RESOURCE, (
                f"Should classify as RESOURCE: {error}"
            )
    ...
    def test_classify_data_error(self):
        ...
        for error in errors:
            ...
            assert category == ErrorCategory.DATA, (
                f"Should classify as DATA: {error}"
            )
    ...
    def test_classify_runtime_error(self):
        ...
        for error in errors:
            ...
            assert category == ErrorCategory.RUNTIME, (
                f"Should classify as RUNTIME: {error}"
            )
...
class TestErrorIsolation:
    ...
    def test_handle_error_returns_continue_action(self):
        ...
        assert action == RecoveryAction.LOG_AND_CONTINUE, (
...
class TestFatalErrorHandling:
    ...
    def test_configuration_error_halts_benchmark(self):
        ...
        assert action == RecoveryAction.HALT_BENCHMARK, (
            "Configuration error should halt benchmark"
        )
    ...
    def test_installation_error_skips_framework(self):
        ...
        assert action == RecoveryAction.SKIP_FRAMEWORK, (
    ...
    def test_timeout_saves_partial_results(self):
        ...
        assert action == RecoveryAction.SAVE_PARTIAL_AND_CONTINUE, (
...
class TestInvalidOutputDetection:
    ...
    def test_detect_inf_metrics(self):
        ...
        inf_errors = [
            issue for issue in report.issues
            if "Inf" in issue.message and issue.severity == "error"
        ]
