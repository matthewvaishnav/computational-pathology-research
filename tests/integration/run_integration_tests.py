...
class IntegrationTestRunner:
    ...
    def save_test_results(self, report: Dict) -> Path:
        ...
        results_file = Path(self.config['results_dir']) / f"integration_test_results_{timestamp}.json"
...
def main():
    ...
    parser.add_argument(
        '--docker',
        action='store_true',
        help='Auto-start Docker services before testing'
    )
    
    parser.add_argument(
        '--no-fixtures',
        action='store_true',
        help='Skip test fixture generation'
    )
