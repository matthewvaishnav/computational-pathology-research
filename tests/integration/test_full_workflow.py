...
class IntegrationTestSuite:
    ...
    def test_dicom_integration(self) -> bool:
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/api/v1/dicom/upload", files=files, timeout=30
            )
            ...
            # Query DICOM study
            response = self.session.get(
                f"{self.base_url}/api/v1/dicom/study/{study_id}", timeout=10
            )
    ...
    def test_error_handling(self) -> bool:
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/api/v1/analyze/upload", files=files, timeout=10
            )
            ...
            response = self.session.post(f"{self.base_url}/api/v1/analyze/upload", timeout=10)
            ...
            response = self.session.get(f"{self.base_url}/api/v1/analyze/invalid-id", timeout=10)
