...
def test_property_29_configuration_validation(invalid_param):
    ...
    **Validates: Requirements 9.3**
    ...
    if param_name in ['feature_dim', 'hidden_dim', 'num_classes', 'dropout', 'multi_scale', 'num_scales', 'fusion_strategy']:
        base_config['model'][param_name] = invalid_value
    elif param_name in ['batch_size', 'learning_rate', 'max_epochs', 'patience', 'checkpoint_interval']:
