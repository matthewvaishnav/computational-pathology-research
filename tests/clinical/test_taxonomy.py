...
class TestDiseaseTaxonomy:
    ...
    def test_init_both_configs(self, simple_taxonomy_dict):
        ...
        with pytest.raises(ValueError, match="Only one of config_path or config_dict should be provided"):
        ...
        invalid_dict = {
            ...
            'diseases': [
                ...
                },
                {
                    ...
                    'name': 'Disease 3',
                    'parent': 'disease2',
                    'children': ['disease1']  # Inconsistent: disease1 doesn't have disease3 as parent
                }
            ]
        }
...
class TestRealTaxonomies:
    ...
    def test_cancer_grading_taxonomy(self):
        ...
        leaves = taxonomy.get_leaf_diseases()
        expected_leaves = {
            "normal", "benign_adenoma", "benign_hyperplasia", "benign_cyst",
    ...
    def test_tissue_types_taxonomy(self):
        ...
        assert set(epithelial_children) == {"squamous_epithelium", "glandular_epithelium", "transitional_epithelium"}
