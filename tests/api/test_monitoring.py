...
def test_monitoring_router_has_endpoints():
    ...
    assert "/api/v1/security/siem/incidents" in routes, "Missing /api/v1/security/siem/incidents endpoint"
...
def test_readiness_endpoint_exists():
    ...
    readiness_routes = [route for route in monitoring.router.routes if route.path == "/api/v1/system/readiness"]
...
def test_ids_alerts_endpoint_exists():
    ...
    ids_routes = [route for route in monitoring.router.routes if route.path == "/api/v1/security/ids/alerts"]
...
def test_siem_incidents_endpoint_exists():
    ...
    siem_routes = [route for route in monitoring.router.routes if route.path == "/api/v1/security/siem/incidents"]
