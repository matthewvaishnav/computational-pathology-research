...
class TestAuthRouter:
    ...
    def test_user_registration_success(self, mock_log, mock_hash, mock_validate_password, mock_validate_email):
    ...
    @patch('src.api.routers.auth.hash_password')
    @patch('src.api.routers.auth.log_security_event')
    def test_user_registration_duplicate_username(self, mock_log, mock_hash, mock_validate_password, mock_validate_email):
    ...
    @patch('time.time')
    @patch('time.sleep')
    def test_user_login_success(self, mock_sleep, mock_time, mock_log, mock_token, mock_clear, mock_verify, mock_lockout):
    ...
    @patch('time.time')
    @patch('time.sleep')
    def test_user_login_invalid_credentials(self, mock_sleep, mock_time, mock_log, mock_record, mock_hash, mock_verify, mock_lockout):
    ...
    @patch('time.time')
    @patch('time.sleep')
    def test_user_login_nonexistent_user(self, mock_sleep, mock_time, mock_log, mock_record, mock_hash, mock_verify, mock_lockout):
    ...
    @patch('src.api.routers.auth.create_access_token')
    @patch('src.api.routers.auth.log_security_event')
    def test_oauth_callback_success_existing_user(self, mock_log, mock_token, mock_user_ops_class, mock_db, mock_callback, mock_create_client):
    ...
    @patch('src.api.routers.auth.create_access_token')
    @patch('src.api.routers.auth.log_security_event')
    def test_oauth_callback_success_new_user(self, mock_log, mock_token, mock_user_ops_class, mock_db, mock_callback, mock_create_client):
