...
def test_admin_router_has_endpoints():
    ...
    assert (
        "/api/v1/admin/reports/generate" in routes
    ), "Missing /api/v1/admin/reports/generate endpoint"
    assert (
        "/api/v1/admin/reports/{report_id}/status" in routes
    ), "Missing /api/v1/admin/reports/{report_id}/status endpoint"
