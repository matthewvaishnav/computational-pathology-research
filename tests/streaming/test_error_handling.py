...
class TestGPUOOMRecovery:
    ...
    def test_oom_error_handling_exists(self, mock_model):
        ...
        pipeline = GPUPipeline(model=mock_model, batch_size=32, memory_limit_gb=1.0)
    ...
    def test_min_batch_size_limit(self, mock_model):
        ...
        assert (
            pipeline.batch_optimizer.current_batch_size >= pipeline.batch_optimizer.min_batch_size
        )
...
class TestBatchSizeOptimization:
    ...
    def test_batch_size_reduction(self):
        ...
        optimizer = BatchSizeOptimizer(initial_batch_size=64, min_batch_size=4, max_batch_size=128)
    ...
    def test_batch_size_increase(self):
        ...
        optimizer = BatchSizeOptimizer(initial_batch_size=32, min_batch_size=4, max_batch_size=128)
    ...
    def test_batch_size_limits(self):
        ...
        optimizer = BatchSizeOptimizer(initial_batch_size=64, min_batch_size=8, max_batch_size=128)
