...
from src.streaming.progressive_visualizer import ProgressiveVisualizer, VisualizationUpdate
...
class TestVisualizationUpdate:
    ...
    def test_initialization(self):
        ...
        update = VisualizationUpdate(timestamp=time.time(), patches_processed=100, confidence=0.85)
...
class TestProgressiveVisualizer:
    ...
    def test_update_attention_heatmap(self, visualizer):
        ...
        visualizer.update_attention_heatmap(
            attention_weights=weights, coordinates=coords, confidence=0.85, patches_processed=3
        )
