...
class BaselineManager:
    ...
    def compare_to_baseline(
        ...
        time_diff_pct = ((current.processing_time_ms - baseline.processing_time_ms) 
                         / baseline.processing_time_ms * 100)
        
        throughput_diff_pct = ((current.throughput_patches_per_sec - baseline.throughput_patches_per_sec) 
                               / baseline.throughput_patches_per_sec * 100)
        
        memory_diff_pct = ((current.peak_memory_mb - baseline.peak_memory_mb) 
