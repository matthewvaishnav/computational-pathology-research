...
from src.clinical.pacs.data_models import StudyInfo, SeriesInfo, OperationResult
...
class TestWorklistManagement:
    ...
    def test_add_to_worklist_with_assignment(self, temp_cache_dir, mock_pacs_adapter, sample_study, sample_series):
        ...
        entry = client.add_to_worklist(
            sample_study,
            priority="STAT",
            assigned_to="pathologist1"
        )
        
        assert entry.priority == "STAT"
        assert entry.assigned_to == "pathologist1"
    
    def test_update_worklist_status(self, temp_cache_dir, mock_pacs_adapter, sample_study, sample_series):
    ...
    def test_get_worklist_filtered_by_priority(self, temp_cache_dir, mock_pacs_adapter, sample_series):
    ...
    def test_get_worklist_filtered_by_status(self, temp_cache_dir, mock_pacs_adapter, sample_series):
...
class TestResultDelivery:
    ...
    def test_deliver_result_to_pacs(self, temp_cache_dir, mock_pacs_adapter, sample_study, sample_series):
...
class TestStatistics:
    ...
    def test_statistics_includes_worklist(self, temp_cache_dir, mock_pacs_adapter, sample_study, sample_series):
