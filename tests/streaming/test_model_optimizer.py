...
class TestModelOptimizer:
    ...
    def test_inference_function_creation(self, test_model, dummy_input, optimization_config):
        ...
        inference_fn = optimizer.create_optimized_inference_fn(
            optimized_model,
            optimization_info
        )
...
class TestParallelPipeline:
    ...
    def test_load_balancer(self, test_model, optimization_config):
        ...
        parallel_config = ParallelConfig(
            gpu_ids=[0],
            batch_distribution="round_robin"
        )
...
class TestIntegration:
    ...
    def test_memory_efficiency(self, test_model):
        ...
        # Optimize model
        optimized_model, inference_fn, _ = optimize_attention_model(
            test_model,
            config,
            large_input
        )
