...
class TestPatchContrastiveLoss:
    ...
    def test_contrastive_loss_hard_negatives(self):
        ...
        loss_fn_with_hard = PatchContrastiveLoss(
            temperature=0.07, use_hard_negatives=True, hard_negative_weight=2.0
        )
        loss_fn_without_hard = PatchContrastiveLoss(temperature=0.07, use_hard_negatives=False)
...
class TestMaskedPatchReconstruction:
    ...
    def test_random_masking(self):
        ...
        loss_fn = MaskedPatchReconstruction(mask_ratio=0.75, mask_strategy="random")
    ...
    def test_block_masking(self):
        ...
        loss_fn = MaskedPatchReconstruction(mask_ratio=0.75, mask_strategy="block", block_size=4)
...
class TestSelfSupervisedPretrainer:
    ...
    def test_pretrainer_initialization(self):
        ...
        pretrainer = SelfSupervisedPretrainer(
            model=encoder, contrastive_weight=1.0, reconstruction_weight=1.0
        )
    ...
    def test_train_step_contrastive_only(self):
        ...
        loss_dict = pretrainer.train_step(
            batch, optimizer, use_contrastive=True, use_reconstruction=False
        )
    ...
    def test_checkpoint_saving_and_loading(self):
        ...
        try:
            ...
            checkpoint_path = pretrainer.save_checkpoint(
                Path(temp_dir), epoch=5, optimizer=optimizer
            )
            ...
            checkpoint = pretrainer_new.load_checkpoint(checkpoint_path, optimizer=optimizer_new)
    ...
    def test_train_step_both_objectives(self):
        ...
        loss_dict = pretrainer.train_step(
            batch, optimizer, use_contrastive=True, use_reconstruction=True
        )
