...
description: Installation, environment setup, and first-run guidance for the HistoCore platform.
---
...
1. **Pretrained Models**
   - [Using Pretrained Encoders](/docs/API_REFERENCE#pretrained-models)
   - Fine-tuning Strategies

2. **Model Comparison**
   - [Baseline Comparisons](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/PCAM_COMPARISON_GUIDE.md)
   - Architecture Search

3. **Deployment**
   - [Docker Deployment](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/DOCKER.md)
   - [REST API](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/deploy/README.md)
   - ONNX Export
...
- [Performance Optimization](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/PERFORMANCE.md) - Speed up training
