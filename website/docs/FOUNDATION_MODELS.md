...
description: Guide to foundation-model support, tradeoffs, and integration patterns inside HistoCore.
---
...
- [Training Optimizations](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/OPTIMIZATION_SUMMARY.md) - 2.5x faster training
- [Inference Optimization](/docs/INFERENCE_OPTIMIZATION) - 2-3x faster inference
- [Performance Comparison](/docs/PERFORMANCE_COMPARISON) - Benchmarks
- [Getting Started](/docs/GETTING_STARTED) - Setup guide
