---
title: Testing
description: Testing strategy, suite organization, and quality assurance workflows for HistoCore.
---
...
- **Integration Tests**: [tests/integration/README.md](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/tests/integration/README.md)
- **Property Tests**: tests/property/README.md
- **Performance Tests**: tests/performance/README.md

### Related Documentation

- **PCam Results**: [PCAM_REAL_RESULTS.md](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/PCAM_REAL_RESULTS.md)
- **Failure Analysis**: [PCAM_FAILURE_ANALYSIS.md](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/PCAM_FAILURE_ANALYSIS.md)
- **Threshold Optimization**: [THRESHOLD_OPTIMIZATION.md](https://github.com/matthewvaishnav/computational-pathology-research/blob/main/docs/THRESHOLD_OPTIMIZATION.md)
- **Clinical Validation**: [CLINICAL_VALIDATION.md](/docs/CLINICAL_VALIDATION)
