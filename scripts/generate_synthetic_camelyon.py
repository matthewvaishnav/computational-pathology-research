...
def main():
    parser = argparse.ArgumentParser(
        description='Generate synthetic CAMELYON16 data for testing'
    )
    parser.add_argument(
        '--output-dir',
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help='Number of training slides'
    )
    parser.add_argument(
        '--num-val',
        type=int,
        default=5,
        help='Number of validation slides'
    )
    parser.add_argument(
        '--num-test',
        type=int,
        default=5,
        help='Number of test slides'
    )
    parser.add_argument(
        '--num-patches',
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=2048,
        help='Feature dimension (ResNet-50 default)'
    )
    parser.add_argument(
        '--seed',
        type=int,
    ...
    logger.info("     python experiments/train_camelyon.py --config experiments/configs/camelyon.yaml")
    logger.info("")
