#!/usr/bin/env python3
"""Analyze frozen five-fold SCORPION PathoAlign test results.

Each of the 48 original slides contributes test outcomes exactly once. Metrics
are averaged over five optimization seeds within slide, then PathoAlign minus
...
def main() -> None:
    ...
    patho = slide_means[slide_means["variant"] == "pathoalign_dep20"].set_index(
        "slide_id"
    )
