...
class DatasetTestRunner:
    ...
    def run_test_suite(self, test_categories: list = None, 
                      source_paths: list = None,
                      pytest_args: list = None) -> dict:
...
def main():
    ...
    parser.add_argument("--skip-coverage", action="store_true",
                       help="Skip full coverage analysis")
    ...
    try:
        ...
        results = runner.run_test_suite(
            args.categories, args.source_paths, args.pytest_args
        )
