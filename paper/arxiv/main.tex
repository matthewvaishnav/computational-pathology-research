...
\]
Raw slides and patch features remain local; only model updates reach the server. The complete definitions and first-order alignment analysis are given in Section~\ref{sec:mathematical-formulation}.
