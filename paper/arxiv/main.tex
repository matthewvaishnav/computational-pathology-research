...
These results remain preliminary. They use frozen ImageNet features and logistic regression rather than pathology-specific foundation-model features or full iterative FL. The supported claim is narrower: under natural Camelyon17 center shift, source-center weighting choices materially affect held-out-center performance, and the sample-volume / site-signal alignment tradeoff appears outside the original simulated PANDA stress tests.
