...
For a standardized frozen feature $x\in\mathbb{R}^{D}$, PathoAlign uses two factor encoders, a joint decoder, and two scanner heads:
\begin{align}
...
\begin{equation}
 ...
 =\frac{1}{d_bd_a}
  ...
  \right\rVert_F^2.
\end{equation}
The frozen PathoAlign objective used in the five-fold and cross-backbone experiments is
\begin{align}
 \mathcal{L}
