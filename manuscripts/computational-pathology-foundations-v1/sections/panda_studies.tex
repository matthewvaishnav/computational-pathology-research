...
The slide-level hierarchy shows the gain from gated attention over a simple pooled baseline in this feature setting. Mean-pooled Phikon plus an MLP reached QWK 0.7274 and gated AttentionMIL reached 0.8100. Historical pre-repair TransnnMIL executions recorded 0.8155, 0.8225, and 0.8086, with a separate 18-run optimizer grid reported in Section~\ref{tab:transnnmil_stability}. Because the historical fusion/topology path was later remediated, those TransnnMIL values remain prediction/execution records rather than current architecture evidence. The repaired matched rerun governs future comparative claims.
