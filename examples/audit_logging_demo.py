...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"    - Integrity verified: {compliance_report['report_metadata']['integrity_verification_passed']}")
        print(f"    - FDA 21 CFR Part 11 compliant: {compliance_report['regulatory_compliance']['fda_21_cfr_part_11_compliant']}")
        print(f"    - Retention period: {compliance_report['regulatory_compliance']['retention_period_years']} years")
        ...
        with AuditContextManager(
            ...
            audit_ctx.log_success(
                {"patient_id": "PATIENT_67890", "image_type": "H&E"},
                result
            )
