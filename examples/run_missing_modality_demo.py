...
def evaluate_config(model, classifier, config_name, num_samples=50):
    ...
    dataset = MissingModalityDataset(num_samples=num_samples, num_classes=3, modality_config=config_name)
...
plt.tight_layout()
plt.savefig('results/missing_modality_demo/missing_modality_performance.png', dpi=300, bbox_inches='tight')
