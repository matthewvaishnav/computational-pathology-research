...
class AdaptiveDecisionSystem:
    ...
    def get_performance_stats(self):
        ...
        return {
            ...
            "total_cases": total,
            "decision_accuracy": self.performance_tracker["imr_wins"] / max(1, self.performance_tracker["imr_wins"] + self.performance_tracker["simple_wins"])
        }
...
def create_test_cases_with_features():
    ...
    cases = [
        ...
        {
            "fl_result": {"cancer_probability": 0.4, "model_confidence": 0.7, "total_training_samples": 500},
            "dmi_result": {"consensus_probability": 0.85, "consensus_strength": 0.9, "specialization_relevance": 0.95},
        ...
        {
            "fl_result": {"cancer_probability": 0.82, "model_confidence": 0.9, "total_training_samples": 100000},
            "dmi_result": {"consensus_probability": 0.85, "consensus_strength": 0.8, "specialization_relevance": 0.7},
        ...
        {
            "fl_result": {"cancer_probability": 0.75, "model_confidence": 0.8, "total_training_samples": 50000},
            "dmi_result": {"consensus_probability": 0.15, "consensus_strength": 0.95, "specialization_relevance": 0.8},
        ...
        {
            "fl_result": {"cancer_probability": 0.5, "model_confidence": 0.6, "total_training_samples": 75000},
            "dmi_result": {"consensus_probability": 0.9, "consensus_strength": 0.95, "specialization_relevance": 0.95},
        ...
        {
            "fl_result": {"cancer_probability": 0.65, "model_confidence": 0.85, "total_training_samples": 200000},
            "dmi_result": {"consensus_probability": 0.68, "consensus_strength": 0.8, "specialization_relevance": 0.7},
...
def test_adaptive_system():
    ...
    for i, case in enumerate(test_cases):
        ...
        if (should_use_imr and method_used == "imr") or (not should_use_imr and method_used == "simple"):
            correct_decisions += 1
        
        print(f"  Case {i+1} ({case_type}):")
        print(f"    Method: {method_used} {'✅' if (should_use_imr and method_used == 'imr') or (not should_use_imr and method_used == 'simple') else '❌'}")
