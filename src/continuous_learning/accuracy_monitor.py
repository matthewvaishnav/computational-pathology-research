...
class AccuracyMonitor:
    ...
    def get_current_metrics(self, disease_type: str, hospital_id: Optional[str] = None) -> Optional[AccuracyMetrics]:
    ...
    def get_metrics_trend(
        ...
        return {
            ...
            "baseline_accuracy": self.baseline_metrics[key].accuracy if key in self.baseline_metrics else None,
            "accuracy_trend": np.polyfit(range(len(accuracies)), accuracies, 1)[0] if len(accuracies) > 1 else 0,
            "f1_trend": np.polyfit(range(len(f1_scores)), f1_scores, 1)[0] if len(f1_scores) > 1 else 0,
    ...
    def get_alert_summary(self, hours: int = 24) -> Dict:
        ...
        return {
            ...
            "affected_hospitals": list(set(alert.hospital_id for alert in recent_alerts if alert.hospital_id)),
