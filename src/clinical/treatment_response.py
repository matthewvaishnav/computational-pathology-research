...
class TreatmentResponseAnalyzer:
    ...
    def visualize_treatment_response_trajectory(
        ...
        """Visualize treatment response trajectory."""
        from .treatment_response_viz import visualize_treatment_response_trajectory as viz_func
        return viz_func(trajectory_data, save_path)

    def visualize_unexpected_responses(
        self, unexpected_cases: List[Dict[str, Any]], save_path: Optional[Union[str, Path]] = None
    ) -> Figure:
        """Visualize unexpected treatment responses."""
        from .treatment_response_viz import visualize_unexpected_responses as viz_func
        return viz_func(unexpected_cases, save_path)

    def visualize_regimen_comparison(
        self, comparison_results: Dict[str, Any], save_path: Optional[Union[str, Path]] = None
    ) -> Figure:
        """Visualize therapeutic regimen comparison."""
        from .treatment_response_viz import visualize_regimen_comparison as viz_func
        return viz_func(comparison_results, save_path)
