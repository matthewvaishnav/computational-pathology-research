...
class CernerEMRPlugin(EMRPlugin):
    ...
    async def _client_credentials_auth(self) -> bool:
        ...
        try:
            ...
            async with self.session.post(
                self.token_url, data=auth_data, headers=headers
            ) as response:
    ...
    async def get_orders(
        self, patient_id: str, order_type: Optional[str] = None
    ) -> List[CernerOrder]:
    ...
    def _parse_fhir_encounter(self, encounter_data: Dict[str, Any]) -> Optional[CernerEncounter]:
        ...
        try:
            ...
            return CernerEncounter(
                ...
                patient_id=encounter_data.get("subject", {})
                .get("reference", "")
                .replace("Patient/", ""),
    ...
    def _parse_fhir_service_request(self, request_data: Dict[str, Any]) -> Optional[CernerOrder]:
        ...
        try:
            ...
            order_details = {
                ...
                "category": (
                    request_data.get("category", [{}])[0].get("coding", [{}])[0].get("display")
            ...
            return CernerOrder(
                ...
                patient_id=request_data.get("subject", {})
                .get("reference", "")
                .replace("Patient/", ""),
                encounter_id=request_data.get("encounter", {})
                .get("reference", "")
                .replace("Encounter/", ""),
