...
class AllscriptsEMRPlugin(EMRPlugin):
    ...
    async def _unity_token_auth(self) -> bool:
        ...
        try:
            ...
            if response and hasattr(response, 'GetTokenResult'):
                ...
                self.token_expires = datetime.now() + timedelta(hours=8)  # Unity tokens typically last 8 hours
    ...
    async def _search_patients_unity(self, search_params: Dict[str, str]) -> List[AllscriptsPatient]:
    ...
    async def get_appointments(self, patient_id: str, 
                             date_range: Optional[tuple] = None) -> List[AllscriptsAppointment]:
    ...
    def _parse_unity_patient_data(self, patient_data: Dict[str, Any]) -> Optional[AllscriptsPatient]:
    ...
    def _parse_unity_appointment_data(self, appointment_data: Dict[str, Any]) -> Optional[AllscriptsAppointment]:
