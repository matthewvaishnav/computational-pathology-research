...
from ..plugin_interface import StoragePlugin, PluginCapability
...
class AWSS3StoragePlugin(StoragePlugin):
    ...
    def metadata(self) -> PluginMetadata:
        ...
        return PluginMetadata(
            ...
            configuration_schema={
                ...
                "encryption_type": {"type": "string", "enum": ["none", "AES256", "aws:kms"], "default": "AES256"},
    ...
    async def upload_file(self, local_path: str, key: str, 
                         metadata: Optional[Dict[str, str]] = None,
                         storage_class: Optional[S3StorageClass] = None) -> Optional[S3UploadResult]:
        """Upload file to S3"""
        try:
    ...
    async def _upload_small_file(self, local_path: str, upload_params: Dict[str, Any]) -> Optional[S3UploadResult]:
    ...
    async def _upload_large_file(self, local_path: str, upload_params: Dict[str, Any]) -> Optional[S3UploadResult]:
        ...
        try:
            ...
            try:
                ...
                async with self.session.client('s3') as s3:
                    await s3.put_object(
                        Bucket=self.bucket_name,
                        Key=self._get_full_key(test_key),
                        Body=test_content
                    )
