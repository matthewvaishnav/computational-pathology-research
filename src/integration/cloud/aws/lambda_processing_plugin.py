...
from ..plugin_interface import ProcessingPlugin, PluginCapability
...
class AWSLambdaProcessingPlugin(ProcessingPlugin):
    ...
    def metadata(self) -> PluginMetadata:
        ...
        return PluginMetadata(
            ...
            configuration_schema={
                ...
                "default_runtime": {"type": "string", "enum": ["python3.9", "python3.10", "python3.11"], "default": "python3.11"},
    ...
    async def deploy_function(self, function_name: str, code_path: str, 
                            handler: str, runtime: Optional[LambdaRuntime] = None,
                            description: Optional[str] = None,
                            timeout: Optional[int] = None,
                            memory_size: Optional[int] = None,
                            environment_variables: Optional[Dict[str, str]] = None,
                            layers: Optional[List[str]] = None) -> Optional[LambdaFunction]:
    ...
    async def invoke_function(self, function_name: str, payload: Optional[Dict[str, Any]] = None,
                            invocation_type: LambdaInvocationType = LambdaInvocationType.SYNCHRONOUS,
                            log_type: LambdaLogType = LambdaLogType.NONE) -> Optional[LambdaInvocationResult]:
    ...
    async def _invoke_local_handler(self, function_name: str, payload: Optional[Dict[str, Any]]) -> LambdaInvocationResult:
    ...
    async def create_layer(self, layer_name: str, code_path: str, 
                          compatible_runtimes: List[LambdaRuntime],
                          description: Optional[str] = None) -> Optional[LambdaLayer]:
        """Create Lambda layer"""
        try:
            # Package layer code
    ...
    async def get_function_logs(self, function_name: str, start_time: Optional[datetime] = None,
                              end_time: Optional[datetime] = None, limit: int = 100) -> List[str]:
