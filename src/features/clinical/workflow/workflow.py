...
from src.features.clinical.workflow.audit import AuditLogger
...
from src.features.clinical.workflow.thresholds import ClinicalThresholdSystem
...
class ClinicalWorkflowSystem:
    ...
    def export_for_regulatory_submission(
        ...
        """
        from src.features.clinical.workflow.regulatory import RegulatoryComplianceManager
