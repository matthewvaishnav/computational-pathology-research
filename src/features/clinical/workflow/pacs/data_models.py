...
class StudyInfo:
    ...
    def validate_for_processing(self) -> bool:
        ...
        pathology_modalities = [
            ...
            "XC",
            "GM",
        ]  # Slide Microscopy, External Camera, General Microscopy
        ...
        if self.tls_enabled:
            ...
            if self.mutual_authentication:
                if not self.client_cert_path or not self.client_cert_path.exists():
                    errors.append(
                        f"Client certificate required for mutual auth: {self.client_cert_path}"
                    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "network_transfer_time": (
                self.network_transfer_time.total_seconds() if self.network_transfer_time else None
            ),
...
class OperationResult:
    ...
    @classmethod
    def error_result(
        cls, operation_id: str, message: str, errors: List[str] = None
    ) -> "OperationResult":
