...
from src.features.clinical.workflow.pacs.data_models import StudyInfo
...
class PACSConnector:
    ...
    def _preprocess_wsi(
        ...
        tensor = torch.from_numpy(np.array(image).transpose(2, 0, 1)).float() / 255.0
    ...
    def get_statistics(self) -> Dict[str, any]:
        ...
        return {
            ...
            "last_query_timestamp": (
                self.last_query_timestamp.isoformat() if self.last_query_timestamp else None
            ),
