...
class UnifiedTrainer:
    ...
    def _compute_test_metrics(self, predictions: torch.Tensor, targets: torch.Tensor) -> Dict[str, float]:
    ...
    def from_config_file(
        ...
        **kwargs
        ...
        if model_type is None:
            ...
            if (config.multi_scale or config.enable_uncertainty or 
                config.window_size != config.bag_length):
                model_type = 'nnmil'
            else:
