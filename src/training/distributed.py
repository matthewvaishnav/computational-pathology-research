...
def save_checkpoint_distributed(
    model: nn.Module, optimizer: torch.optim.Optimizer, epoch: int, filepath: str, **kwargs
) -> None:
    """
...
def load_checkpoint_distributed(
    model: nn.Module, optimizer: torch.optim.Optimizer, filepath: str, device: torch.device
) -> dict:
    """
