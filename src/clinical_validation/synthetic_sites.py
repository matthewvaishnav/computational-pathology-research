...
class SyntheticSiteGenerator:
    ...
    def _generate_data_quality(self, site_id: str, template: Dict) -> DataQualityProfile:
        ...
        return DataQualityProfile(
            ...
            compression_artifacts_rate=max(0, 0.1 - image_quality * 0.1 + np.random.normal(0, 0.02)),
    ...
    def _generate_operations(self, site_id: str, template: Dict, case_volume: int) -> OperationalProfile:
        ...
        return OperationalProfile(
            ...
            error_rate=max(0.001, 0.02 - template["data_quality_base"] * 0.015 + np.random.normal(0, 0.005)),
...
if __name__ == "__main__":
    ...
    for i, site in enumerate(sites, 1):
        ...
        print(f"   Demographics: {demo.caucasian_percentage:.1%} Caucasian, "
