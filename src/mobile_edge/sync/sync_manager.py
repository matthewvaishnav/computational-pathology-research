    ...
    def update_connectivity(
        ...
        with self.lock:
            ...
            if is_connected and not old_connected:
                logger.info(
                    "Connectivity restored: %s (%.1f Mbps)", connection_type, bandwidth_mbps or 0
                )
    ...
    def _sync_worker(self) -> None:
        ...
        try:
            ...
            self.loop.call_later(
                self.config.sync_interval_minutes * 60, self._schedule_periodic_sync
            )
