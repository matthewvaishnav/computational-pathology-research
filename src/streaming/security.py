...
class SecurityManager:
    ...
    def __init__(self, config: SecurityConfig):
        ...
        self.encryption_manager = EncryptionManager(config) if config.enable_at_rest_encryption else None
        self.key_manager = KeyManager(config)
        self.token_generator = TokenGenerator()
        
        logger.info("Security manager initialized: tls=%s encryption=%s",
                   config.enable_tls, config.enable_at_rest_encryption)
