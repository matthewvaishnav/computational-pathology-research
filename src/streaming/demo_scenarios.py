...
class DemoDataGenerator:
    ...
    PATIENT_NAMES = [
        ...
        "David Rodriguez", "Barbara Martinez"
    ]
    ...
    def generate_slide(case_index: int = 0) -> SyntheticSlide:
        ...
        return SyntheticSlide(
            ...
            patient_name=DemoDataGenerator.PATIENT_NAMES[case_index % len(DemoDataGenerator.PATIENT_NAMES)],
...
class DemoScenarioRunner:
    ...
    async def run_realtime_demo(self) -> Dict:
        ...
        while processed < total_patches:
            ...
            print(f"Update: {progress:5.1f}% complete | "
...
async def main():
    ...
    print(f"  - Accuracy: {results['accuracy_demo']['average_confidence']*100:.0f}% avg confidence ✓")
