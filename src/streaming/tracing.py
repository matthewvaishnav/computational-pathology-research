...
class TracedWSIProcessor:
    ...
    def load_slide(self, slide_path: str):
        ...
        add_span_attributes(
            ...
            slide_format=slide_path.split('.')[-1]
        )
        ...
        add_span_event('slide_loaded', {
            'dimensions': '40000x30000',
            'levels': 5
        })
    ...
    async def process_on_gpu(self, patches: list, gpu_id: int = 0):
        ...
        add_span_event('gpu_processing_complete', {
            'throughput': len(patches) / 0.05
        })
