...
class ModelSecurityManager:
    ...
    def get_security_status(self) -> Dict[str, Any]:
        ...
        recent_threats = [
            log for log in self.audit_logs[-100:]  # Last 100 events
            if log.threat_type is not None
        ]
        ...
        return {
            ...
            'key_fingerprint': self._get_key_fingerprint(self.verification_key) if self.verification_key else None,
