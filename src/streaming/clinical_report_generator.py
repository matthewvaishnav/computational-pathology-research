...
class StreamingReportGenerator:
    ...
    def __init__(self, 
        ...
        logger.info(f"Initialized StreamingReportGenerator for {institution_name} (language: {self.language})")
    ...
    def generate_pdf_report(self, 
        ...
        if self.template.include_clinical_notes and (report_data.physician_notes or report_data.recommendations):
    ...
    def _build_patient_info(self, report_data: StreamingReportData) -> List:
        ...
        data = [
            ...
            [f"{self.t('report_date')}:", report_data.report_timestamp.strftime('%Y-%m-%d %H:%M:%S')],
        ]
