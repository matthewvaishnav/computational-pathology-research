...
ROLE_PERMISSIONS: Dict[Role, Set[Permission]] = {
    Role.ADMIN: {
        Permission.VIEW_SLIDES, Permission.PROCESS_SLIDES, Permission.DELETE_SLIDES,
        Permission.EXPORT_SLIDES, Permission.VIEW_RESULTS, Permission.MODIFY_RESULTS,
        Permission.APPROVE_RESULTS, Permission.MANAGE_USERS, Permission.MANAGE_SYSTEM,
        Permission.VIEW_AUDIT_LOGS, Permission.EXPORT_DATA, Permission.DELETE_DATA
    },
    Role.PATHOLOGIST: {
        Permission.VIEW_SLIDES, Permission.PROCESS_SLIDES, Permission.EXPORT_SLIDES,
        Permission.VIEW_RESULTS, Permission.MODIFY_RESULTS, Permission.APPROVE_RESULTS,
        Permission.EXPORT_DATA
    },
    Role.CLINICIAN: {
        Permission.VIEW_SLIDES, Permission.PROCESS_SLIDES, Permission.VIEW_RESULTS,
        Permission.EXPORT_DATA
    },
    Role.RESEARCHER: {
        Permission.VIEW_SLIDES, Permission.PROCESS_SLIDES, Permission.VIEW_RESULTS,
    ...
    Role.VIEWER: {
        Permission.VIEW_SLIDES, Permission.VIEW_RESULTS
    }
}
...
class RBACManager:
    ...
    def require_role(self, user: User, role: Role):
        ...
        if not user.has_role(role):
            raise PermissionError(
                f"User {user.username} lacks role: {role.value}"
            )
