...
def create_secure_temp_file(suffix: str = "", prefix: str = "histocore_", dir: Optional[str] = None) -> Path:
...
def create_secure_temp_dir(suffix: str = "", prefix: str = "histocore_", dir: Optional[str] = None) -> Path:
