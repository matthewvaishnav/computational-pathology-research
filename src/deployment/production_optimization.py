...
class PerformanceMonitor:
    ...
    def _collect_system_metrics(self):
        ...
        # Check for alerts
        self._check_performance_alerts(timestamp, site_id, {
            "cpu": cpu_percent,
    ...
    def _check_performance_alerts(self, timestamp: datetime, site_id: str, metrics: Dict[str, float]):
...
class AutoScaler:
    ...
    def _check_scaling_conditions(self):
        ...
        for component, policy in self.scaling_policies.items():
            ...
            if (policy["last_action"] and 
                (current_time - policy["last_action"]).total_seconds() < policy["cooldown_minutes"] * 60):
                continue
    ...
    def _get_recent_metric_value(self, metric_name: str, component: str, minutes_back: int = 5) -> Optional[float]:
    ...
    def _generate_capacity_recommendations(self, projections: Dict[str, Any]) -> List[CapacityPlan]:
        ...
        for key, proj in projections.items():
            ...
            if metric == "cpu_utilization":
                if projected > 80:
                    recommendations.append(CapacityPlan(
                        component=component,
    ...
    def setup_monitoring_alerting(self) -> Dict[str, Any]:
        ...
        monitoring_config = {
            ...
            "alert_channels": [
                {
                    "type": "email",
                    "recipients": ["ops@hospital.com", "support@medai.com"]
                },
                {
                    "type": "slack",
