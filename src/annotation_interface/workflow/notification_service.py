...
class NotificationService:
    ...
    async def notify_task_assignment(
        self, expert_id: str, task_id: str, slide_id: str, deadline: Optional[datetime] = None
    ):
        """
    ...
    async def notify_urgent_case(
        self, expert_ids: List[str], task_id: str, slide_id: str, reason: str
    ):
        """
    ...
    async def _send_email_notification(self, expert_id: str, message: Dict[str, Any]):
    ...
    async def _send_webhook_notification(self, expert_id: str, message: Dict[str, Any]):
    ...
    def register_webhook(self, expert_id: str, webhook_url: str):
        """
    ...
    def unregister_webhook(self, expert_id: str, webhook_url: str):
        """
    ...
    def _determine_notification_priority(
        self, task_priority: float, uncertainty_score: float
    ...
    def _record_notification(self, message: Dict[str, Any], channels: List[NotificationChannel]):
