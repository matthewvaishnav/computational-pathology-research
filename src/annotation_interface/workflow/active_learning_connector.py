...
from ..backend.annotation_models import AnnotationQueueItem, SlideInfo
...
class ActiveLearningConnector:
    ...
    async def _submit_case_to_annotation_interface(self, al_task: ALAnnotationTask):
        """
    ...
    async def submit_expert_feedback(
        ...
        try:
            ...
            # Submit to AL system
            success = self.al_system.receive_expert_feedback(task_id, expert_annotation)
