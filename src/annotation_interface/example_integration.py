...
class AnnotationInterfaceIntegration:
    ...
    def submit_uncertain_cases_for_annotation(
        self,
        cases: List[CaseForReview]
    ) -> List[str]:
        """
    ...
    def collect_completed_annotations(
        self,
        slide_id: str
    ...
    def process_annotation_feedback_loop(
        self,
        task_id: str,
        slide_id: str
    ):
...
async def example_workflow():
    ...
    active_learning = ActiveLearningSystem(
        ...
        min_annotations_for_retraining=10
    )
