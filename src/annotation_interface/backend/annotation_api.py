    ...
    try:
        ...
        # For regular images, use PIL
            ...
            try:
                ...
                # Crop tile
                tile = img.crop((x_pos, y_pos, x_pos + tile_size, y_pos + tile_size))
    ...
    try:
        ...
        try:
            ...
            return AIPredictionOverlay(
                ...
                confidence=0.0,
                regions=[],
                metadata={"model": "placeholder", "note": "InferenceEngine not available"},
            )
        except Exception as e:
            ...
            return AIPredictionOverlay(
                ...
                confidence=0.0,
                regions=[],
                metadata={"error": str(e), "note": "Prediction generation failed"},
            )
