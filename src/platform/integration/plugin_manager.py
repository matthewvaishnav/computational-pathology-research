...
class PluginManager:
    ...
    def _start_health_check(self, name: str):
        ...
        thread = threading.Thread(target=self._health_check_loop, args=(name,), daemon=True)
        thread.start()
    ...
    def get_all_status(self) -> List[Dict[str, Any]]:
        ...
        return [self.get_plugin_status(name) for name in self.registry.list_plugins()]
...
if __name__ == "__main__":
    from .plugin_interface import PluginMetadata, ScannerPlugin
