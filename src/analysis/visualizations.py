...
class VisualizationGenerator:
    ...
    def _create_radar_chart(
        ...
        try:
            ...
            # Add title
            plt.title(f'Analysis Dimension Scores\nOverall: {result.overall_score:.1f}/100',
    ...
    def _create_complexity_histogram(
        ...
        try:
            ...
            # Create histogram
            n, bins, patches = ax.hist(complexities, bins=20, color='skyblue', edgecolor='black', alpha=0.7)
    ...
    def _create_interactive_dashboard(
        ...
        try:
            ...
            fig = make_subplots(
                rows=2, cols=2,
                subplot_titles=('Dimension Scores', 'Issue Distribution',
                               'Coverage Metrics', 'Security Status'),
            ...
            # Update layout
            fig.update_layout(
                title_text="HistoCore Analysis Dashboard",
                showlegend=False,
                height=800
            )
    ...
    def _create_issue_sunburst(
        ...
        try:
            ...
            fig.update_layout(
                title="Issue Distribution by Dimension",
                height=600
            )
