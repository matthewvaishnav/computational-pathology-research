...
class FeatureImportanceCalculator:
    ...
    def __init__(
        ...
        logger.info(f"FeatureImportanceCalculator initialized with {method} method on {self.device}")
    ...
    def compute_confidence_intervals(
        ...
        for _ in range(n_bootstrap):
            ...
            importance = self.compute_importance(
                X_boot, y_boot, feature_names, n_repeats=n_repeats
            )
