...
class AttentionConfig:
    ...
    def validate(self) -> Tuple[bool, Optional[str]]:
        ...
        if self.architecture not in valid_architectures:
            return False, f"architecture must be one of {valid_architectures}, got '{self.architecture}'"
...
class AttentionPrettyPrinter:
    ...
    def format(data: AttentionData, hdf5_path: Path, compression_level: int = 4):
        ...
        logger.info(f"Saved attention data to {hdf5_path} with compression level {compression_level}")
