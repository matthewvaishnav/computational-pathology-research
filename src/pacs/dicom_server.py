...
class DicomServer:
    ...
    def __init__(self, ae_title: str = "MEDICAL_AI", port: int = 11112,
...
def create_medical_ai_dicom_server(port: int = 11112, storage_dir: str = "/tmp/dicom_storage") -> DicomServer:
