...
class ResultPostprocessor:
    ...
    def process_results(self, probabilities: torch.Tensor, class_names: List[str],
                       model_name: str, model_version: str) -> InferenceResult:
        ...
        try:
            ...
            probability_scores = {
                ...
                for class_name, prob in zip(class_names, probs_np)
            }
    ...
    def calibrate_confidence(self, result: InferenceResult, 
                           calibration_params: Dict[str, float]) -> InferenceResult:
    ...
    def add_clinical_interpretation(self, result: InferenceResult, 
    ...
    def format_for_api(self, result: InferenceResult) -> Dict[str, Any]:
        ...
        api_result = {
            ...
            "probability_scores": {
                k: round(v, 4) for k, v in result.probability_scores.items()
            },
