...
async def http_exception_handler(request: Request, exc: StarletteHTTPException) -> JSONResponse:
    ...
    """
    logger.warning(
        f"HTTP Exception: {request.method} {request.url} - {exc.status_code}: {exc.detail}"
    )
...
def create_error_response(
    status_code: int, message: str, detail: str = None, extra_data: Dict[str, Any] = None
) -> Dict[str, Any]:
    """
    ...
    """
    response = {"error": get_error_name(status_code), "message": message}
