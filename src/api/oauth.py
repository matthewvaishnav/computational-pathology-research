...
class OAuthConfig:
    ...
    def __init__(
        ...
        if provider == "azure":
            ...
            self.userinfo_endpoint = userinfo_endpoint or "https://graph.microsoft.com/oidc/userinfo"
            ...
            self.authorization_endpoint = authorization_endpoint or "https://accounts.google.com/o/oauth2/v2/auth"
            self.token_endpoint = token_endpoint or "https://oauth2.googleapis.com/token"
            self.userinfo_endpoint = userinfo_endpoint or "https://openidconnect.googleapis.com/v1/userinfo"
        ...
        logger.info(f"OAuth config initialized: provider={provider} client_id={self.client_id[:8]}...")
...
class OAuthClient:
    ...
    def __init__(self, config: OAuthConfig):
        ...
        self.config = config
        self.state_store: Dict[str, datetime] = {}  # In-memory state storage (use Redis in production)
