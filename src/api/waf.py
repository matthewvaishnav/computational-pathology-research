...
class WAFEngine:
    ...
    def _record_violation(self, ip: str) -> None:
        ...
        if self.violation_counts[ip] >= self.block_threshold:
            ...
            logger.warning(f"IP {ip} blocked until {block_until} after {self.violation_counts[ip]} violations")
        ...
        if violation:
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "message": violation.get("message", "Your request was blocked due to security policy")
                }
            )
