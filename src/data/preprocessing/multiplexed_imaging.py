...
class MultiplexedImageProcessor:
    ...
    def __init__(
        self, channel_names: Optional[List[str]] = None, normalize_per_channel: bool = True
    ):
        """
    ...
    def process_multiplexed_image(
        self, image: np.ndarray, channel_names: Optional[List[str]] = None
    ) -> Dict[str, np.ndarray]:
        """
    ...
    def extract_marker_positive_regions(
        self, channel: np.ndarray, threshold: Optional[float] = None, method: str = "otsu"
    ) -> np.ndarray:
        """
...
class CODEXProcessor(MultiplexedImageProcessor):
    ...
    def __init__(
        self, marker_panel: Optional[List[str]] = None, background_subtraction: bool = True
    ):
        """
    ...
    def subtract_background(self, image: np.ndarray, radius: int = 50) -> np.ndarray:
        """
...
class VectraProcessor(MultiplexedImageProcessor):
    ...
    def __init__(self, marker_panel: Optional[List[str]] = None, spectral_unmixing: bool = True):
        """
    ...
    def unmix_spectra(self, image: np.ndarray, unmixing_matrix: np.ndarray) -> np.ndarray:
        """
...
def process_codex_image(
    ...
    processor = CODEXProcessor(
        marker_panel=marker_panel, background_subtraction=background_subtract
    )
...
def process_vectra_image(
    ...
    processor = VectraProcessor(
        marker_panel=marker_panel, spectral_unmixing=unmixing_matrix is not None
    )
