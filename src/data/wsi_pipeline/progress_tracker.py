...
class ProgressTracker:
    ...
    def finish(self) -> ProcessingStats:
        ...
        if self.stats.failed_items > 0:
            logger.warning(f"Failed items: {self.stats.failed_items} ({self.stats.failure_rate:.1f}%)")
...
class BatchProgressMonitor:
    ...
    def get_aggregate_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "patches_per_second": (patches_processed / total_processing_time) if total_processing_time > 0 else 0,
