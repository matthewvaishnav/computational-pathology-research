...
def test_dmi_expertise_weighting():
    ...
    dmi.register_medical_center("expert_center", {
        "medical_tier": "comprehensive_cancer_center",
    ...
    dmi.register_medical_center("standard_center", {
        "medical_tier": "community_hospital",
...
def test_dmi_knowledge_synthesis():
    ...
    # Register centers
    dmi.register_medical_center("center_a", {
        "medical_tier": "academic_medical_center",
        "diagnostic_accuracy": 0.90
    })
    
    dmi.register_medical_center("center_b", {
        "medical_tier": "specialty_hospital", 
        "diagnostic_accuracy": 0.95
    })
    
    # Contribute different insights
    dmi.contribute_medical_insights("center_a", {
        "lung_cancer": {"accuracy": 0.85, "confidence": 0.80}
    })
    
    dmi.contribute_medical_insights("center_b", {
        "lung_cancer": {"accuracy": 0.92, "confidence": 0.88}
    })
...
def test_dmi_specialization_matching():
    ...
    dmi.register_medical_center("breast_specialist", {
        "medical_tier": "specialty_hospital",
        "specializations": ["breast_cancer", "mammography"],
        "diagnostic_accuracy": 0.94
    })
    
    dmi.register_medical_center("lung_specialist", {
        "medical_tier": "specialty_hospital",
