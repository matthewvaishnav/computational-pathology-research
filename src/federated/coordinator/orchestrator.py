...
from src.federated.common.data_models import ClientUpdate, ModelCheckpoint, TrainingRound
...
class TrainingOrchestrator:
    ...
    def complete_round(self, convergence_metrics: Optional[Dict[str, float]] = None):
        """
