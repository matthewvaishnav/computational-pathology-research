...
class FederatedTrainer:
    ...
    def train_epoch(
        self, batch_size: int = 32, learning_rate: float = 0.01, epochs: int = 1
    ) -> Dict[str, Any]:
        ...
        if self.privacy_engine:
            ...
            privacy_metrics = {
                ...
                "remaining_budget": self.privacy_engine.accountant.get_remaining_budget(
                    10.0
                ),  # Assume 10.0 budget limit
            }
