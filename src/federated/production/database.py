...
class Client(Base):
    ...
    # Status
    status = Column(String(50), nullable=False, default="registered")  # registered, active, inactive, suspended
...
class TrainingRound(Base):
    ...
    # Status
    status = Column(String(50), nullable=False, default="pending")  # pending, active, completed, failed
...
class DatabaseManager:
    ...
    def create_training_round(self, round_id: int, algorithm: str, min_clients: int, max_clients: int) -> TrainingRound:
    ...
    def update_training_round(self, round_id: int, **kwargs):
        ...
        with self.get_session() as session:
            round_obj = session.query(TrainingRound).filter(TrainingRound.round_id == round_id).first()
            if round_obj:
    ...
    # Audit logging
    def log_audit_event(self, event_type: str, event_category: str, description: str, 
                       user_id: str = None, client_id: str = None, success: bool = True, **kwargs):
    ...
    # Metrics
    def record_metric(self, metric_name: str, metric_value: float, component: str, 
                     metric_unit: str = None, labels: Dict[str, Any] = None):
