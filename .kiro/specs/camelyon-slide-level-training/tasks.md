...
- [x] 1. Implement core slide-level dataset infrastructure
  - [x] 1.1 Create CAMELYONSlideDataset class in src/data/camelyon_dataset.py
  ...
  - [x] 1.2 Implement collate_slide_bags function in src/data/camelyon_dataset.py
  ...
  - [x] 1.3 Write unit tests for CAMELYONSlideDataset
  ...
  - [x] 1.4 Write unit tests for collate_slide_bags
...
- [x] 2. Update training script for slide-level batching
  - [x] 2.1 Create create_slide_dataloaders function in experiments/train_camelyon.py
  ...
  - [x] 2.2 Update train_epoch function to handle slide-level batches
  ...
  - [x] 2.3 Update validate function for slide-level validation
  ...
  - [x] 2.4 Add configuration validation in train_camelyon.py
...
- [x] 3. Checkpoint - Ensure training script runs
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Update model for masked aggregation
  - [x] 4.1 Update SimpleSlideClassifier.forward in src/models/wsi_models.py
  ...
  - [x] 4.2 Write unit tests for masked aggregation
...
- [x] 5. Create YAML configuration for slide-level training
  - [x] 5.1 Create experiments/configs/camelyon.yaml
...
- [x] 6. Update evaluation script for slide-level checkpoints
  - [x] 6.1 Verify evaluate_camelyon.py loads slide-level checkpoints
  ...
  - [x] 6.2 Write integration test for evaluation script
...
- [x] 7. Checkpoint - Ensure evaluation works
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Add comprehensive testing
  - [x] 8.1 Create synthetic CAMELYON data generator for testing
  ...
  - [x] 8.2 Write end-to-end training integration test
  ...
  - [x] 8.3 Write end-to-end evaluation integration test
...
- [x] 9. Update documentation
  - [x] 9.1 Update train_camelyon.py module docstring
  ...
  - [x] 9.2 Add CAMELYON slide-level training section to README
  ...
  - [x] 9.3 Update evaluate_camelyon.py docstring
