...
class MultimodalTrainer:
    ...
    def __init__(
        ...
        self.global_step = 0
        self.best_val_metric = float('-inf') if config.get('maximize_metric', True) else float('inf')
    ...
    def train(self):
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            improved = (current_metric > self.best_val_metric) if maximize else \
...
def parse_args():
    ...
    parser.add_argument('--monitor-metric', type=str, default='val_accuracy',
