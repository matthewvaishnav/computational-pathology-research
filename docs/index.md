...
\[
w*t = \arg\max*{w\in\mathcal W}\sum_i w_i\left(\hat\phi_i^{Owen}+\lambda_DD_i^{useful}+\lambda_FF_i+\lambda_QQ_i-\lambda_SS_i\right)
\]
...
**FAIR-WEIGHTS-H Documentation:**

- [Protocol Specification](FAIR_WEIGHTS_HYBRID_PROTOCOL) - Mathematical framework and design principles
- [Implementation Status](FAIR_WEIGHTS_H_IMPLEMENTATION_STATUS) - What is implemented, what is not, how to use
- [Synthetic Report](FAIR_WEIGHTS_H_SYNTHETIC_REPORT) - Perturbation experiment results (engineering check only)
...
7. [FAIR-WEIGHTS-H Implementation Status](FAIR_WEIGHTS_H_IMPLEMENTATION_STATUS)
8. [Security Hardening](SECURITY_HARDENING)
...
| FAIR-WEIGHTS-H engine               | Experimental implementation | `src/features/federated/pathology_fl/weighting/fair_weights_h.py`, [FAIR-WEIGHTS-H Protocol](FAIR_WEIGHTS_HYBRID_PROTOCOL), [Implementation Status](FAIR_WEIGHTS_H_IMPLEMENTATION_STATUS) |
| Explicit weighted aggregation       | Implemented adapter         | `src/features/federated/pathology_fl/aggregator/weighted.py`                                                                                                                              |
| Synthetic perturbation experiments  | Implemented scaffold        | `src/features/federated/pathology_fl/weighting/experiment_suite.py`, [Synthetic Report](FAIR_WEIGHTS_H_SYNTHETIC_REPORT)                                                                  |
| FAIR-WEIGHTS-H tests                | Implemented                 | `tests/federated/test_fair_weights_h.py`, `tests/federated/test_weighting_benchmark.py` (27/27 passing)                                                                                   |
