...
This benchmark attacks the PathoAlign canine branch-separation result with stronger probes than the default linear identity audit.
...
| sample_id | PathoAlign biological features | 75 | 0.989164 | 0.007756 | 0.986343 | 0.080745 |
| sample_id | PathoAlign acquisition features | 75 | 0.236147 | 0.115624 | 0.226930 | 0.080745 |
...
| scanner_id | PathoAlign biological features | 75 | 0.254705 | 0.035569 | 0.254705 | 0.200000 |
| scanner_id | PathoAlign acquisition features | 75 | 0.970756 | 0.005956 | 0.970756 | 0.200000 |

## Per-probe scanner identity results

| Probe | Raw DINOv2 | Paired reference | PathoAlign biological | PathoAlign acquisition |
|---|---:|---:|---:|---:|
...
For scanner prediction under sample-blocked cross-validation, PathoAlign biological features remain close to chance and far below raw DINOv2 and paired-reference features. Averaged across linear, random-forest, and kNN probes, scanner prediction is 0.254705 for the PathoAlign biological branch, compared with 0.661863 for raw DINOv2, 0.573419 for paired-reference features, and 0.970756 for the PathoAlign acquisition branch.

For sample prediction under scanner-blocked cross-validation, PathoAlign biological features preserve biological identity. Averaged across the same probes, sample prediction is 0.989164 for the PathoAlign biological branch, compared with 0.941946 for raw DINOv2 and 0.236147 for the PathoAlign acquisition branch.
...
Under stronger linear, random-forest, and kNN probes across folds and seeds, PathoAlign biological features remain weakly scanner-decodable but strongly sample-decodable, while PathoAlign acquisition features remain strongly scanner-decodable and weakly sample-decodable.
