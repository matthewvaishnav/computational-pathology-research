# Paired-Acquisition Neural Factorization Figure 1 benchmark table

## Figure title

**Paired-Acquisition Neural Factorization separates biological identity from acquisition identity in pathology representations.**

## One-sentence caption

Raw DINOv2 features entangle scanner and biological identity; Paired-Acquisition Neural Factorization produces a biological branch with low scanner decodability and high biological recoverability, and an acquisition branch with high scanner decodability and low biological recoverability.
...
| Paired-Acquisition Neural Factorization biological branch | 25 | **0.299955** | **0.959463** | **0.998966** | 0.835016 | 180.615 | 0.000000 |
| Paired-Acquisition Neural Factorization acquisition branch | 25 | **0.968407** | 0.031155 | 0.420661 | 0.308065 | 47.355 | 0.000000 |
...
| Target | Raw DINOv2 | Paired reference | Paired-Acquisition Neural Factorization biological | Paired-Acquisition Neural Factorization acquisition |
|---|---:|---:|---:|---:|
