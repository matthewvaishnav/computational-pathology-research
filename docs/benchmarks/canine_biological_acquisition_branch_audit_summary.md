# Canine PathoAlign biological versus acquisition branch audit

## Purpose

This benchmark audit tests the stronger PathoAlign separation claim on the external multi-scanner canine SCC paired-acquisition feature set:

- the PathoAlign biological branch should suppress scanner identity while preserving biological recoverability;
- the PathoAlign acquisition branch should preserve scanner identity;
...
| PathoAlign biological features | `results/external_multiscanner_caninescc/pathoalign_dinov2_crossfold/fold_0/runs/pathoalign_dep20_seed_{911..915}/projected_features.npz`, key `features` |
| PathoAlign acquisition features | `results/external_multiscanner_caninescc/pathoalign_dinov2_crossfold/fold_0/runs/pathoalign_dep20_seed_{911..915}/projected_features.npz`, key `acquisition_features` |
...
| PathoAlign biological features | 5 | 0.296845 | 0.204919 | 0.958211 | 0.999354 | 0.839324 | 181.210 | 0.000000 |
| PathoAlign acquisition features | 5 | 0.961391 | 0.227230 | 0.035180 | 0.426683 | 0.322286 | 47.987 | 0.000000 |

## Interpretation

The biological branch sharply suppresses scanner decodability relative to raw DINOv2 while preserving or improving biological retrieval. Scanner-probe accuracy falls from 0.878261 in raw DINOv2 to 0.296845 in the PathoAlign biological branch, while region-level retrieval increases from 0.872547 to 0.958211 and sample-level retrieval increases from 0.985839 to 0.999354.
